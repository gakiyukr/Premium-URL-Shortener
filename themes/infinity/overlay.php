...
<html lang="en" prefix="og: http://ogp.me/ns#">
  <head>       
    ...
    <script type="text/javascript" src="<?php echo $this->config["url"] ?>/themes/<?php echo $this->config["theme"] ?>/js/application.fn.js?v=1.0"></script>
    <script type="text/javascript" src="<?php echo $this->config["url"] ?>/themes/<?php echo $this->config["theme"] ?>/js/application.js?v=1.0"></script>    
  ...
  <body<?php echo Main::body_class() ?> id="main-overlay" style="overflow:hidden">
    <section>
        <div class='custom-message <?php echo $position ?>' style='background-color: <?php echo $bg; ?> !important'>
            ...
            <a href="<?php echo $url->url ?>" class="remove"><i class="zmdi zmdi-close-circle" style="font-size: 19px;"></i></a>
        </div><!-- /.custom-message --> 
